...
public class ValaRaidSystem {
	...
	public void startValakas(L1PcInstance pc){
		...
		L1SpawnUtil.spawn2(32733, 32937, (short) id, 60032, 0, fire_delay * 1000, id); // 倉庫
		L1SpawnUtil.spawn2(32727, 32937, (short) id, 3310016, 0, fire_delay * 1000, id); // 雑貨商人
		L1SpawnUtil.spawn2(32751, 32928, (short) id, 3310017, 0, fire_delay * 1000, id); // レア入り口
		L1SpawnUtil.spawn2(32738, 32925, (short) id, 170017, 0, fire_delay * 1000, id); // 森
