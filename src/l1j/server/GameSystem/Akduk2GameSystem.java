			...
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1BuffNpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 7000068) {
						...
						Thread.sleep(1000);
						Thread.sleep(1000);
						String chat2 = "ホールorペア2倍//// 1〜6数字3倍///ホールペアor数字を入力してください";
		...
		try {
			for (L1Object l1object : L1World.getInstance().getObject()) {
				if (l1object instanceof L1BuffNpcInstance) {
					...
					if (Npc.getNpcTemplate().get_npcId() == 7000068) {
						L1BuffNpcInstance dealer = Npc;
						String chat9 = pc.getName() + "様になりました. "
								+ pc.getGamblingMoney() * 2 + "支払いました.";
						String chat10 = pc.getName() + "様になりました."
								+ pc.getGamblingMoney() * 3 + "支払いました.";
						String chat11 = pc.getName() + "間違っています.";
						...
						case 1:
							...
							String chat = pc.getName()
									+ "さんホールを選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 2:
							...
							String chat2 = pc.getName()
									+ "さんのペアを選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 3:
							...
							String chat3 = pc.getName()
									+ "さん1を選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 4:
							...
							String chat4 = pc.getName()
									+ "さん2を選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 5:
							...
							String chat5 = pc.getName()
									+ "さん3を選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 6:
							...
							String chat6 = pc.getName()
									+ "さん4を選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 7:
							...
							String chat7 = pc.getName()
									+ "さん5を選択しました。 遠くに行くとゲームがキャンセルされます.";
						...
						case 8:
							...
							String chat8 = pc.getName()
									+ "さん6を選択しました。 遠くに行くとゲームがキャンセルされます.";
