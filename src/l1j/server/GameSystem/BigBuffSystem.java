	...
	public void run() {
		...
		try {
			...
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.GLOWING_AURA,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(npc1.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.SHINING_AURA,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Thread.sleep(1000L);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.BRAVE_AURA,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Thread.sleep(1000L);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.MIRROR_IMAGE,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.CONCENTRATION,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.INSIGHT,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc,
					L1SkillId.IllUSION_DIAMONDGOLEM, _pc.getId(), _pc.getX(),
					_pc.getY(), null, 0, L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(_npc.getId(),
					19));
			new L1SkillUse().handleCommands(_pc, L1SkillId.MORTAL_BODY,
					_pc.getId(), _pc.getX(), _pc.getY(), null, 0,
					L1SkillUse.TYPE_GMBUFF);
			Broadcaster.broadcastPacket(npc1, new S_DoActionGFX(npc1.getId(),
					19));
