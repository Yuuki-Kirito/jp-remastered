...
public class L1MobSkill implements Cloneable {
	...
	public static final int TYPE_PAPOO_1 = 5;

	public static final int TYPE_PAPOO_2 = 6;

	public static final int TYPE_PAPOO_3 = 7;

	public static final int TYPE_LINE_ATTACK = 8;

	public static final int TYPE_KIRTAS_METEOR = 9;

	public static final int TYPE_KIRTAS_BARRIER = 10;
