...
public class L1Skills {
	...
	private int _targetTo; // 0:自分 1:PC 2:NPC 4:血盟 8:パーティー 16:ペット 32:場所
	...
	public int getScrollReuseDelay() {
		return _ScrollreuseDelay;
	}

	public void setScrollReuseDelay(int i) {
		_ScrollreuseDelay = i;
	}
