  ...
  private void BossSpawn(){
    try{
      int i = rnd.nextInt(4);
        ...
        L1World.getInstance().broadcastServerMessage("\\aFギラン監獄1階のどこかに主任ギフト泥棒が現れました。");
        L1World.getInstance().broadcastPacketToAll(new S_PacketBox(84, "\\aFギラン監獄1階のどこかに主任ギフト泥棒が現れました。"));
    } catch (Exception e) {
     e.printStackTrace();
    }
  }
