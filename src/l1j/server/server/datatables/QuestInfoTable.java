	...
	private void LoadInfo() {
		for (QuestInfoTemp quest : QuestInfoList) {
			...
			while (s.hasMoreElements()) {
				temp = s.nextToken();
				String temp2 = "";
				StringTokenizer values = new StringTokenizer(temp, "クエスト目標：モンスター狩りアイテム獲得支給経験値番号数量テレポート座標");
