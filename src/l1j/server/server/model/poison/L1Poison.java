...
public abstract class L1Poison {
	protected static boolean isValidTarget(L1Character cha) {
		...
		if (player.getInventory().checkEquipped(20298) // 제니스의반지
				|| player.getInventory().checkEquipped(120298) // 축제니스의반지
				...
				|| player.getInventory().checkEquipped(27528)
				|| player.getInventory().checkEquipped(27529)
				|| player.getInventory().checkEquipped(27530)
