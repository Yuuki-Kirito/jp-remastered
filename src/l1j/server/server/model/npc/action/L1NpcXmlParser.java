...
public class L1NpcXmlParser {
	...
	static {
		...
		_questIds.put("level70", L1Quest.QUEST_LEVEL80);
		...
		_questIds.put("marbin", L1Quest.QUEST_MARBIN);
		_questIds.put("silverfirst", L1Quest.QUEST_SILVER_FIRST);
		_questIds.put("silverhunt", L1Quest.QUEST_SILVER_HUNT);
		_questIds.put("silverdragontears", L1Quest.QUEST_SILVER_DRAGON_TEARS);
	}
