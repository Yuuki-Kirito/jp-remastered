...
public class L1NpcListedAction extends L1NpcXmlAction {
	...
	public FastTable<L1NpcMakeItemAction> MakeItemActionlist() {
		FastTable<L1NpcMakeItemAction> list = new FastTable<L1NpcMakeItemAction>();
		for (L1NpcAction action : _actions) {
			if (action instanceof L1NpcMakeItemAction)
				list.add((L1NpcMakeItemAction) action);
		}
		return list;
	}
}
