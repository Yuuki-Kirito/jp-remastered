...
public class L1TownLocation {
	...
	private static final Point[] GETBACK_LOC_ADEN = { new Point(33936, 33353),
			new Point(33934, 33353), new Point(33921, 33337),
			new Point(33936, 33353), new Point(33936, 33353),
			new Point(33936, 33353), new Point(33936, 33353),
			new Point(33936, 33353), };
