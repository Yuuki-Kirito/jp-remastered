...
public class L1FollowerInstance extends L1NpcInstance {
			...
			if (object instanceof L1NpcInstance) {
				...
				case 71062:
					if (getLocation()
						...
						pc = (L1PcInstance) _master;
						if ((pc.getX() >= 32448 && pc.getX() <= 32452) // ¸ðÅüÀÌ ¸ð½º
																		// ÁÖº¯ ÁÂÇ¥
	...
	public void onTalkAction(L1PcInstance player) {
		...
		case 71062:
			if (_master.equals(player)) {
				player.sendPackets(new S_NPCTalkReturn(getId(), "kamit2"), true);
			} else {
				player.sendPackets(new S_NPCTalkReturn(getId(), "kamit1"), true);
			}
			break;
		case 71075:
			if (_master.equals(player)) {
		...
		case 70957:
			if (_master.equals(player)) {
				player.sendPackets(new S_NPCTalkReturn(getId(), "roi2"), true);
			} else {
				player.sendPackets(new S_NPCTalkReturn(getId(), "roi2"), true);
			}
			break;
	...
	public void onPerceive(L1PcInstance perceivedFrom) {
		...
		perceivedFrom
				.sendPackets(new S_FollowerPack(this, perceivedFrom), true);
	}
