...
public class ResurrectionScroll extends L1ItemInstance {
	...
	public void clickItem(L1Character cha, ClientBasePacket packet) {
		if (cha instanceof L1PcInstance) {
			...
			L1Object obj = L1World.getInstance().findObject(packet.readD());
			L1Character resobject = null;

			if (obj instanceof L1Character) {
				resobject = (L1Character) obj;
			}
			if (resobject != null) {
					...
					if (L1World.getInstance().getVisiblePlayer(target, 0)
						...
						for (L1PcInstance visiblePc : L1World.getInstance()
							...
							if (!visiblePc.isDead()) {
								...
								pc.sendPackets(new S_ServerMessage(592), true);
								return;
							}
						}
					}
