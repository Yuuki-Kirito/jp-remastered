...
public class GeneralThreadPool {
	...
	// L1J デフォルト状態で、map:4 に何もしていない PC が 1 秒間に占める実行時間は約
	// 6ms(AutoUpdate: 약 6ms, ExpMonitor:very small)
	private final int _pcSchedulerPoolSize = 1 + Config.MAX_ONLINE_USERS / 20; // 適当(20
																				// User에
																				// 1改正の
																				// 割り当て)
	...
	private class PriorityThreadFactory implements ThreadFactory {
		...
		/*
		 * public ThreadGroup getGroup() { return _group; }
		 */
	}
}
