		...
		try {
			...
			if (totalsoldier + totalCount > clanBossChar) {
				...
				S_SystemMessage sm = new S_SystemMessage(
						"카리스마 부족으로 더 이상 고용 할 수 없습니다.");
				pc.sendPackets(sm, true);
				S_SystemMessage sm2 = new S_SystemMessage("고용 되어있는 수: "
						+ totalsoldier + " 하려는 수: " + totalCount);
			...
			for (int i = 0; i < count; i++) {
				...
				case 0:
					...
					S_SystemMessage sm = new S_SystemMessage(
							soldier.getSoldier1Name() + "를 "
									+ soldierInfor[i].count + " 명 고용 하였습니다.");
					pc.sendPackets(sm, true);
					break;
				case 1:
