...
public class C_HotelEnter extends ClientBasePacket {
	...
	public C_HotelEnter(byte abyte0[], LineageClient client) throws Exception {
		 ...
		 * 
		 * pc.setX(32743); pc.setY(32803); pc.setMap((short)16385);
		 * pc.sendPackets(new S_CloseList(5345345)); pc.sendPackets(new
		 * S_SkillSound(pc.getId(), 169)); pc.sendPackets(new S_MapID(16384,
		 * false)); pc.sendPackets(new S_OwnCharPack(pc));
