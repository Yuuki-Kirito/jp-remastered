...
public class S_ServerMessage extends ServerBasePacket {
	...
	public S_ServerMessage(int type, String msg1, String msg2, boolean ok) {
		buildPacket(type, msg1, msg2, ok);
	}
	...
	public S_ServerMessage(int type, int msg1, int msg2) {
	...
	private void buildPacket(int type, String msg, String msg2, boolean ok) {
	...
	private void buildPacket(int type, int msg, int msg2) {
		writeC(Opcodes.S_MESSAGE_CODE);
		writeH(type);
		writeC(2);
		writeH(msg);
