...
public abstract class CharactersItemStorage {
	...
	public abstract void storeItem(L1PcInstance pc, L1ItemInstance item) throws Exception;
	...
	public abstract void updateItemDemonBongin(L1ItemInstance item) throws Exception;
	...
	public abstract void updateItemStepEnchantLevel(L1ItemInstance item) throws Exception;

	public abstract void updateItemRegistLevel(L1ItemInstance item) throws Exception;
